...
class GenerateImplement extends Command
{
     ...
     * @var string
     */
    protected $description = 'Genera un implemento en la carpeta ImplementsManager';
    ...
    public function handle()
    {
        ...
        $filePath = base_path('app/Http/ImplementsManager/' . $filename . 'Implement.php'); // Ruta absoluta dentro de la carpeta app
        ...
        $content .= 'namespace App\Http\ImplementsManager;' . PHP_EOL . PHP_EOL;
